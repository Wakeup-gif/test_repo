...
| Probe-backed menu, Leads, and Install Calendar repairs | B5-C light | `logic/B5C-PROBE-THEME-DELTA.md`, v2.3.3 read-only probe | Core Sleek Dark adapter/on with Sleek Dark | existing SquareCoil host only | CSS-only presentation after bounded pathname classification | Authorized; automated and installed Chrome/Edge acceptance pending |

...
test('A3 B1 regression guard executes the three real B4 dist bundles', () => {
  const harness = createA3Harness();
  assert.equal(harness.buildInfo.stage, 'B4');
  assert.match(harness.buildInfo.buildId, /b4-data-safety/i);

...
// @version      1.0.1
// @description  SquareCoil light cinematic glass with v2.3.4 typography parity, one Bing wallpaper engine, frosted surfaces, native icon safeguards, FullCalendar, and CKEditor. Presentation only; no business actions.
...
(function () {
  ...
  if (window.__usSignFullUILightGlassThemeV100 || window.__usSignFullUILightGlassThemeV101) return;
  window.__usSignFullUILightGlassThemeV100 = true;
  window.__usSignFullUILightGlassThemeV101 = true;
  ...
  root.dataset.usSignLightGlassThemeVersion = "1.0.1";
  ...
  if (typeof GM_registerMenuCommand === "function") {
    GM_registerMenuCommand(
      enabled ? "Disable SquareCoil Light Glass v1.0.1" : "Enable SquareCoil Light Glass v1.0.1",
      () => {
...
html.us-sign-v240.us-sign-theme-light-glass {
  ...
  --usl-font-ui: "Manrope","Avenir Next",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;
  --usl-font-display: "Space Grotesk","Manrope","Avenir Next",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;
...
html.us-sign-v240 :is(h1,h2,h3,h4,h5,h6,.page-title,.panel-title) {
  color: var(--usl-text) !important;
...
html.us-sign-v240 #topbar :is(a,.breadcrumb,.breadcrumb > li,.breadcrumb > li + li::before) {
  color: var(--usl-text-soft) !important;
  font-family: var(--usl-font-ui) !important;
}
...
html.us-sign-v240 #pmlt :is(h1,h2,strong,b),
html.us-sign-v240 #project_menu :is(h1,h2,strong,b) {
  color: var(--usl-text) !important;
  font-family: var(--usl-font-display) !important;
  letter-spacing: -.015em !important;
}
...
/* Keep v2.3.4 typography from replacing SquareCoil's native icon fonts. */
html.us-sign-v240 body :is(.fa,i.fa,span.fa,[class^="fa-"],[class*=" fa-"]),
html.us-sign-v240 body #pmlt :is(.fa,i.fa,span.fa,[class^="fa-"],[class*=" fa-"]) {
...
html.us-sign-v240 body :is(.glyphicon,[class^="glyphicon-"],[class*=" glyphicon-"]),
html.us-sign-v240 body #pmlt :is(.glyphicon,[class^="glyphicon-"],[class*=" glyphicon-"]) {
...
html.us-sign-v240 body :is(.glyphicons,[class^="glyphicons-"],[class*=" glyphicons-"]),
html.us-sign-v240 body #pmlt :is(.glyphicons,[class^="glyphicons-"],[class*=" glyphicons-"]) {
...
html.us-sign-v240 body :is(.imoon,[class^="imoon-"],[class*=" imoon-"],i[class^="icon-"],i[class*=" icon-"],span[class^="icon-"],span[class*=" icon-"]),
html.us-sign-v240 body #pmlt :is(.imoon,[class^="imoon-"],[class*=" imoon-"],i[class^="icon-"],i[class*=" icon-"],span[class^="icon-"],span[class*=" icon-"]) {
...
html.us-sign-v240 #ussign-job-timer,
html.us-sign-v240 #ussign-job-timer * {
  font-family: inherit;
}
...
`);
  ...
  const EDITOR_STYLE_ID = "us-sign-light-glass-v101-ckeditor-document";

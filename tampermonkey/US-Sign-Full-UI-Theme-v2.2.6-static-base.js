// ==UserScript==
// @name         US Sign Full UI Static Dark Glass Base
// @namespace    us-sign-full-modules
// @version      2.2.6-static.1
// @description  Static SquareCoil Dark Glass route and component foundation for newer skins. Legacy wallpaper rotation and pointer parallax are intentionally disabled so one cinematic background engine owns motion.
...
(function () {
  ...
  GM_addStyle(String.raw`
    ...
    *::after {
    ...
    @supports ((-webkit-backdrop-filter: blur(1px)) or (backdrop-filter: blur(1px))) {
      ...
      #projectbox,
      #designbox {
        -webkit-backdrop-filter: blur(16px) saturate(130%) brightness(0.90) !important;
        backdrop-filter: blur(16px) saturate(130%) brightness(0.90) !important;
      }
    }
    ...
    @supports ((-webkit-backdrop-filter: blur(1px)) or (backdrop-filter: blur(1px))) {
      ...
      #designbox,
      #filesbox {
        -webkit-backdrop-filter: blur(18px) saturate(125%) brightness(0.90) !important;
        backdrop-filter: blur(18px) saturate(125%) brightness(0.90) !important;
      }
    ...
    .topbar {
      ...
      -webkit-backdrop-filter: blur(24px) saturate(155%) brightness(0.90) !important;
      backdrop-filter: blur(24px) saturate(155%) brightness(0.90) !important;
    }
    ...
    #sidebar_left {
      ...
      -webkit-backdrop-filter: blur(24px) saturate(150%) brightness(0.90) !important;
      backdrop-filter: blur(24px) saturate(150%) brightness(0.90) !important;
    }
    ...
    #pmlt {
      ...
      -webkit-backdrop-filter: blur(22px) saturate(145%) brightness(0.90) !important;
      backdrop-filter: blur(22px) saturate(145%) brightness(0.90) !important;
    }
    ...
    #showbtns {
      ...
      -webkit-backdrop-filter: blur(20px) saturate(145%) brightness(0.90) !important;
      backdrop-filter: blur(20px) saturate(145%) brightness(0.90) !important;
    }
    ...
    html body #pmlt {
      -webkit-backdrop-filter: blur(12px) saturate(130%) brightness(0.90) !important;
      backdrop-filter: blur(12px) saturate(130%) brightness(0.90) !important;
    }
    ...
    /* v2.2.6: Bold Fraunces is reserved for project identity. The project
    ...
    html body .topbar {
      ...
      -webkit-backdrop-filter: blur(14px) saturate(138%) brightness(0.90) !important;
      backdrop-filter: blur(14px) saturate(138%) brightness(0.90) !important;
    }
    ...
    html body #sidebar_left {
      ...
      -webkit-backdrop-filter: blur(12px) saturate(132%) brightness(0.90) !important;
      backdrop-filter: blur(12px) saturate(132%) brightness(0.90) !important;
    }
    ...
    html body #pmlt {
      ...
      -webkit-backdrop-filter: blur(10px) saturate(126%) brightness(0.90) !important;
      backdrop-filter: blur(10px) saturate(126%) brightness(0.90) !important;
    }
    ...
    html.us-sign-search-page #push-down .panel.heading-border.panel-primary {
      ...
      -webkit-backdrop-filter: blur(7px) saturate(126%) brightness(0.90) !important;
      backdrop-filter: blur(7px) saturate(126%) brightness(0.90) !important;
    }
    ...
    html.us-sign-search-page #push-down .alert.alert-success {
      ...
      box-shadow:
        ...
        inset 0 1px 0 rgba(255, 255, 255, 0.04) !important;
      -webkit-backdrop-filter: blur(6px) saturate(124%) brightness(0.90) !important;
      backdrop-filter: blur(6px) saturate(124%) brightness(0.90) !important;
    }
    ...
    html.us-sign-job-dashboard #content .tray-center > .pl15.pr15 > .well:has(.important-notes) {
      ...
      -webkit-backdrop-filter: blur(8px) saturate(118%) brightness(0.90) !important;
      backdrop-filter: blur(8px) saturate(118%) brightness(0.90) !important;
    }
    ...
    @supports ((-webkit-backdrop-filter: blur(1px)) or (backdrop-filter: blur(1px))) {
      ...
      html.us-sign-job-dashboard #customer-info,
      html.us-sign-job-dashboard #content .tray-center > .pl15.pr15 > .well:has(.important-notes) {
        -webkit-backdrop-filter: blur(14px) saturate(132%) brightness(0.90) !important;
        backdrop-filter: blur(14px) saturate(132%) brightness(0.90) !important;
      }

      html.us-sign-job-dashboard #content .tray-center :is(.panel, .well, .panel-tile, .tab-content) {
        -webkit-backdrop-filter: blur(10px) saturate(124%) brightness(0.90) !important;
        backdrop-filter: blur(10px) saturate(124%) brightness(0.90) !important;
      }
      ...
      html.us-sign-design-page #us-sign-design-right-stack > .us-sign-designs-panel,
      html.us-sign-design-page #us-sign-design-right-stack > .us-sign-files-panel {
        -webkit-backdrop-filter: blur(11px) saturate(126%) brightness(0.90) !important;
        backdrop-filter: blur(11px) saturate(126%) brightness(0.90) !important;
      }
    ...
    html.us-sign-main-dashboard #content :is(
      ...
      -webkit-backdrop-filter: blur(16px) saturate(132%) brightness(0.95) brightness(0.90) !important;
      backdrop-filter: blur(16px) saturate(132%) brightness(0.95) brightness(0.90) !important;
    }
    ...
    html.us-sign-main-dashboard #content .panel-tile {
      ...
      -webkit-backdrop-filter: blur(22px) saturate(145%) brightness(0.96) brightness(0.90) !important;
      backdrop-filter: blur(22px) saturate(145%) brightness(0.96) brightness(0.90) !important;
    }
    ...
    html.us-sign-main-dashboard #widget-estimates {
      ...
      box-shadow:
        ...
        inset 0 1px 0 rgba(255, 255, 255, 0.060) !important;
      -webkit-backdrop-filter: blur(22px) saturate(145%) brightness(0.97) brightness(0.90) !important;
      backdrop-filter: blur(22px) saturate(145%) brightness(0.97) brightness(0.90) !important;
    }
    ...
    html.us-sign-main-dashboard #page-content .panel-body.bg-light {
      ...
      box-shadow:
        ...
        inset 0 1px 0 rgba(255, 255, 255, 0.045) !important;
      -webkit-backdrop-filter: blur(20px) saturate(138%) brightness(0.96) brightness(0.90) !important;
      backdrop-filter: blur(20px) saturate(138%) brightness(0.96) brightness(0.90) !important;
    }
    ...
    #modal-overlay.duplicate-modal-2 {
      ...
      -webkit-backdrop-filter: blur(14px) saturate(108%) brightness(0.80) brightness(0.90) !important;
      backdrop-filter: blur(14px) saturate(108%) brightness(0.80) brightness(0.90) !important;
    }
    ...
    html body #sidebar_left {
      ...
      -webkit-backdrop-filter: blur(9px) saturate(122%) brightness(0.96) brightness(0.90) !important;
      backdrop-filter: blur(9px) saturate(122%) brightness(0.96) brightness(0.90) !important;
    }
    ...
    html body #sidebar_left {
      ...
      -webkit-backdrop-filter: blur(8px) saturate(120%) brightness(0.96) brightness(0.90) !important;
      backdrop-filter: blur(8px) saturate(120%) brightness(0.96) brightness(0.90) !important;
    ...
    html body #sidebar_left {
      ...
      background-image:
        linear-gradient(180deg,
          ...
          rgba(5, 18, 30, 0.18) 52%,
          rgba(4, 14, 24, 0.24) 100%) !important;
      -webkit-backdrop-filter: blur(6px) saturate(116%) brightness(0.94) brightness(0.90) !important;
      backdrop-filter: blur(6px) saturate(116%) brightness(0.94) brightness(0.90) !important;
    }
    ...
    ========================================================= */
      ...
      html.us-sign-theme-dark-glass body #us-sign-job-overview,
      html.us-sign-theme-dark-glass body #us-sign-design-summary,
      html.us-sign-theme-dark-glass body #us-sign-design-bottom-grid,
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack,
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-summary .us-sign-djt-summary-cell,
      html.us-sign-theme-dark-glass body #us-sign-job-overview td,
      html.us-sign-theme-dark-glass body #us-sign-job-overview th {
        background-color: rgba(255, 255, 255, 0.012) !important;
        border-color: rgba(255, 255, 255, 0.055) !important;
      }

      html.us-sign-theme-dark-glass body #us-sign-job-lookup-button,
      html.us-sign-theme-dark-glass body #us-sign-design-actionbar :is(a,button,.btn):not([data-us-state]),
      html.us-sign-theme-dark-glass body #us-sign-job-copy-tools :is(a,button,.btn):not([data-us-state]),
      html.us-sign-theme-dark-glass body #us-sign-native-action-group :is(a,button,.btn):not([data-us-state]) {
      ...
      html.us-sign-theme-dark-glass body #us-sign-job-lookup-button:hover,
      html.us-sign-theme-dark-glass body #us-sign-design-actionbar :is(a,button,.btn):not([data-us-state]):hover,
      html.us-sign-theme-dark-glass body #us-sign-job-copy-tools :is(a,button,.btn):not([data-us-state]):hover,
      html.us-sign-theme-dark-glass body #us-sign-native-action-group :is(a,button,.btn):not([data-us-state]):hover {
        color: #fff !important;
        background: rgba(255, 255, 255, 0.070) !important;
        border-color: rgba(255, 255, 255, 0.120) !important;
      }

      /* v4.1.6: direct moved panels are true outer frost roots. */
      html.us-sign-theme-dark-glass body #us-sign-design-actionbar,
      html.us-sign-theme-dark-glass body #us-sign-job-overview,
      html.us-sign-theme-dark-glass body #us-sign-design-summary,
      html.us-sign-theme-dark-glass body #us-sign-design-bottom-grid > .us-sign-description-panel,
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-bottom-grid,
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack,
      html.us-sign-theme-dark-glass body #us-sign-design-actionbar :is(a,button,.btn,.us-sign-native-action),
      html.us-sign-theme-dark-glass body #us-sign-job-overview :is(.us-sign-overview-title,.us-sign-overview-field),
      html.us-sign-theme-dark-glass body #us-sign-design-summary > .us-sign-djt-summary-cell,
      html.us-sign-theme-dark-glass body #us-sign-design-bottom-grid > .us-sign-description-panel :is(.panel-heading,.panel-body,.panel-footer,.panel-menu),
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel :is(.panel-heading,.panel-body,.panel-footer,.panel-menu),
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-files-panel :is(.panel-heading,.panel-body,.panel-footer,.panel-menu) {
        -webkit-backdrop-filter:none !important;
        backdrop-filter:none !important;
      }
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-summary + div:has(> table[aria-hidden="true"]) {
        display: none !important;
      }
      ...
      html.us-sign-theme-dark-glass body #us-sign-job-copy-tools .us-sign-copy-toolbar,
      html.us-sign-theme-dark-glass body #us-sign-native-action-group {
        display: inline-flex !important;
        align-items: center !important;
        gap: 6px !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-actionbar :is(button, a.btn, .us-sign-native-action) {
        min-height: 32px !important;
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-actionbar :is(button, a.btn, .us-sign-native-action):hover,
      html.us-sign-theme-dark-glass body #us-sign-design-actionbar :is(button, a.btn, .us-sign-native-action):focus-visible {
        color: #ffffff !important;
      ...
      html.us-sign-theme-dark-glass body #us-sign-job-overview .us-sign-overview-stack {
        display: grid !important;
        gap: 5px !important;
        padding: 5px 6px 5px 0 !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-job-overview .us-sign-overview-row {
        gap: 5px !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-job-overview .us-sign-overview-title {
        display: flex !important;
        align-items: center !important;
      ...
      html.us-sign-theme-dark-glass body #us-sign-job-overview .us-sign-overview-field {
      ...
      html.us-sign-theme-dark-glass body #us-sign-job-overview .us-sign-overview-field:hover,
      html.us-sign-theme-dark-glass body #us-sign-job-overview .us-sign-overview-field:focus-visible {
        color: #ffffff !important;
        background: rgba(255,255,255,.045) !important;
        border-color: rgba(255,255,255,.09) !important;
        outline: none !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-job-overview .us-sign-overview-label,
      html.us-sign-theme-dark-glass body #us-sign-design-summary .us-sign-djt-summary-label {
        color: #949aa2 !important;
        font-size: 9.5px !important;
        font-weight: 650 !important;
        letter-spacing: .015em !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-job-overview .us-sign-overview-value {
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-summary .us-sign-djt-summary-value:not([data-us-state]) {
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-bottom-grid > .us-sign-description-panel > .panel-heading,
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel > .panel-heading,
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-files-panel > .panel-heading {
        display: flex !important;
        align-items: center !important;
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack .panel-heading :is(.widget-menu, .pull-right) {
        display: flex !important;
        align-items: center !important;
        float: none !important;
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel > .panel-heading a.btn,
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-files-panel > .panel-heading a.btn {
        display: inline-flex !important;
        align-items: center !important;
        justify-content: center !important;
        min-height: 30px !important;
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > :is(.us-sign-designs-panel,.us-sign-files-panel) > .panel-heading a.btn:hover,
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > :is(.us-sign-designs-panel,.us-sign-files-panel) > .panel-heading a.btn:focus-visible {
        color: #ffffff !important;
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-bottom-grid > .us-sign-description-panel > .panel-body {
        padding: 14px 16px 16px !important;
        color: #d7dbe0 !important;
        line-height: 1.55 !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-bottom-grid > .us-sign-description-panel > .panel-body > .row {
        margin: 0 !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-bottom-grid > .us-sign-description-panel > .panel-body > .row > [class*="col-"] {
        width: 100% !important;
        max-width: none !important;
        padding: 0 !important;
        overflow: visible !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > :is(.us-sign-designs-panel,.us-sign-files-panel) > .panel-body {
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel table {
        width: 100% !important;
        background: transparent !important;
        border: 0 !important;
        border-collapse: separate !important;
      ...
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel tr[bgcolor],
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel td[bgcolor] {
        background: transparent !important;
        background-color: transparent !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel td {
        padding: 8px 10px !important;
        background: rgba(255,255,255,.018) !important;
        border-top: 1px solid rgba(255,255,255,.045) !important;
        border-bottom: 1px solid rgba(255,255,255,.045) !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel td:first-child {
        border-left: 1px solid rgba(255,255,255,.045) !important;
        border-radius: 7px 0 0 7px !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel td:last-child {
        border-right: 1px solid rgba(255,255,255,.045) !important;
        border-radius: 0 7px 7px 0 !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel tr:hover td {
        background: rgba(255,255,255,.038) !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel a.linknostyle,
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel a.linknostyle[style] {
        color: #dce2e8 !important;
        font-weight: 600 !important;
        text-decoration: none !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-designs-panel a.linknostyle:hover {
        color: #ffffff !important;
      }

      /* Empty Files tables currently render as a 1px bordered artifact. Replace
         that with a quiet empty-state label instead. */
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-files-panel > .panel-body:has(table:not(:has(td,th))) {
        display: flex !important;
        align-items: center !important;
        min-height: 46px !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-files-panel > .panel-body:has(table:not(:has(td,th))) table {
        display: none !important;
      }
      html.us-sign-theme-dark-glass body #us-sign-design-right-stack > .us-sign-files-panel > .panel-body:has(table:not(:has(td,th)))::after {
  ...
  if (document.documentElement) {
    document.documentElement.dataset.usSignLegacyWallpaperRuntime = "static-base-disabled";
  }
  ...
  if (document.documentElement) {
    document.documentElement.dataset.usSignLegacyParallaxRuntime = "static-base-disabled";
  }

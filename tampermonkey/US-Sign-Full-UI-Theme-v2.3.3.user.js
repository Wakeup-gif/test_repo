// ==UserScript==
// @name         US Sign Full UI Theme v2.3.3
// @name:en      US Sign Full UI Theme v2.3.3
// @namespace    us-sign-full-modules
// @version      2.3.3
// @description  Audit-driven SquareCoil dark cinematic glass with corrected filters, dropdowns, FullCalendar, CKEditor canvas, and high-contrast toolbar icons. Presentation only; no business actions.
...
(function () {
  ...
  if (window.__usSignFullUIThemeV233) return;
  window.__usSignFullUIThemeV233 = true;

  const root = document.documentElement;
  if (!root) return;

  const ENABLED_KEY = "us-sign-v233-dark-adapter-enabled";
  const enabled = typeof GM_getValue === "function" ? GM_getValue(ENABLED_KEY, true) !== false : true;

  root.dataset.usSignThemeAuditVersion = "2.3.3";
  ...
  if (typeof GM_registerMenuCommand === "function") {
    GM_registerMenuCommand(
      enabled ? "Disable SquareCoil Dark v2.3.3" : "Enable SquareCoil Dark v2.3.3",
      () => {
  ...
  GM_addStyle(String.raw`
    ...
    html.us-sign-v230 {
      color-scheme: dark;
      --v230-page: rgba(5,11,17,.20);
      --v230-shell: rgba(7,15,23,.84);
      --v230-shell-strong: rgba(5,12,19,.93);
      --v230-surface: rgba(9,18,27,.82);
      --v230-surface-strong: rgba(7,15,23,.93);
      ...
      --us-squarecoil-glass: rgba(7,13,20,.87);
      --us-squarecoil-glass-soft: rgba(8,15,23,.81);
      --us-squarecoil-glass-strong: rgba(5,11,18,.93);
    ...
    html.us-sign-v230 #sidebar_left {
      ...
      -webkit-backdrop-filter: blur(18px) saturate(116%) brightness(84%) !important;
      backdrop-filter: blur(18px) saturate(116%) brightness(84%) !important;
    }
    ...
    html.us-sign-v230 #topbar {
      color: var(--v230-text-soft) !important;
      background: rgba(7,15,23,.46) !important;
    ...
    html.us-sign-v230 #project_menu {
      color: var(--v230-text-soft) !important;
      background-color: rgba(5,12,19,.91) !important;
    ...
    html.us-sign-v230 .popover {
      ...
      -webkit-backdrop-filter: blur(16px) saturate(116%) brightness(86%) !important;
      backdrop-filter: blur(16px) saturate(116%) brightness(86%) !important;
    }
    ...
    /* v2.3.3 live-probe corrections: native controls and nested rows repaint
    ...
    html.us-sign-v230[data-us-sign-v230-route="dashboard"] :is(#widget-tasks,#widget-designs,#widget-estimates) {
      ...
      -webkit-backdrop-filter: blur(14px) saturate(114%) brightness(88%) !important;
      backdrop-filter: blur(14px) saturate(114%) brightness(88%) !important;
      overflow: hidden !important;
    }
  ...
  const EDITOR_STYLE_ID = "us-sign-v233-ckeditor-document";
